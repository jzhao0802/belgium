...
%let missing_value=%nrstr(("not recorded","ni","unable to obtain","refused","unable","unble","not specified","unspecified","n/a",
				"ni","n\a","n i", "unknown", "unsure of usage","0x","1x",".","'","none","u", "unclassified"));

libname lunc "F:\yxue\Luncentis\2015Q1";
%let outpath=F:\yxue\Luncentis\summary;
